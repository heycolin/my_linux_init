...
--end
--tags[1][1].name = ' [gvim] '
--tags[1][2].name = ' [terminal] '
--tags[1][3].name = ' [virtualbox] '
--tags[1][4].name = ' [brower] '
--tags[1][5].name = ' [else] '

tags = {
    settings = {
        {
            names  = { " [gvim] ", " [terminal] ", " [virtualbox] ", " [brower] ", " [else] " },
            layout = { layouts[2], layouts[2], layouts[1], layouts[1], layouts[4] }
        },
    },
}
...
mytasklist = {}
mytasklist.buttons = awful.util.table.join(awful.button({ }, 1, 
    function (c)
...
awful.util.spawn_with_shell("xset r rate 150 100")
awful.util.spawn_with_shell("source ~/.vimrc")
awful.util.spawn_with_shell("/home/colin/my_goagent/run.sh")
--awful.util.spawn_with_shell("oneko")
